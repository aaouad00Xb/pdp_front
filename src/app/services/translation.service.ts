  ...
  private loadTranslations() {
    ...
    this.translations['fr'] = {
      ...
      editor: {
        ...
        importTab: 'Import Excel',
        uploadExcelLabel: 'Télécharger un fichier Excel (.xlsx)',
        acceptedFormats: 'Format accepté: .xlsx, .xls (Max: 10MB)',
        downloadTemplate: 'Télécharger le modèle',
        downloadTemplateBtn: 'Télécharger modèle Excel',
        templateHint: 'Utilisez ce modèle pour formater vos données',
        selectedFile: 'Fichier sélectionné',
        import: 'Importer',
        importing: 'Importation...',
        instructions: 'Instructions:',
        step1: 'Téléchargez le modèle Excel pour voir le format requis',
        step2: 'Remplissez vos données dans le modèle',
        step3: 'Assurez-vous que toutes les colonnes obligatoires sont remplies',
        step4: 'Sélectionnez votre fichier et cliquez sur "Importer"',
        settingsTab: 'Paramètres',
        appSettings: 'Paramètres de l\'Application',
        logoManagement: 'Gestion des Logos',
        leftLogo: 'Logo Principal (Gauche)',
        rightLogo: 'Logo Secondaire (Droite)',
        changeLeftLogo: 'Changer le logo principal:',
        changeRightLogo: 'Changer le logo secondaire:',
        titleManagement: 'Gestion du Titre',
        titleFr: 'Titre (Français):',
        titleAr: 'العربية (العنوان):',
        titlePreview: 'Aperçu du titre:',
        saveSettings: 'Sauvegarder les Paramètres',
        reset: 'Réinitialisation',
        resetHint: 'Restaurer les paramètres par défaut de l\'application.',
        ...
        sortHint: 'Trier par colonnes en cliquant sur les en-têtes',
        showing: 'Affichage',
        of: 'sur',
        items: 'éléments',
    ...
    this.translations['ar'] = {
      ...
      editor: {
        ...
        importTab: 'استيراد إكسل',
        uploadExcelLabel: 'تحميل ملف إكسل (.xlsx)',
        acceptedFormats: 'الصيغ المقبولة: .xlsx, .xls (الحد الأقصى: 10MB)',
        downloadTemplate: 'تحميل النموذج',
        downloadTemplateBtn: 'تحميل نموذج إكسل',
        templateHint: 'استخدم هذا النموذج لتنسيق بياناتك',
        selectedFile: 'الملف المحدد',
        import: 'استيراد',
        importing: 'جاري الاستيراد...',
        instructions: 'تعليمات:',
        step1: 'حمّل نموذج الإكسل لرؤية التنسيق المطلوب',
        step2: 'املأ بياناتك في النموذج',
        step3: 'تأكد من ملء جميع الأعمدة الإلزامية',
        step4: 'اختر ملفك وانقر على "استيراد"',
        settingsTab: 'الإعدادات',
        appSettings: 'إعدادات التطبيق',
        logoManagement: 'إدارة الشعارات',
        leftLogo: 'الشعار الرئيسي (يسار)',
        rightLogo: 'الشعار الثانوي (يمين)',
        changeLeftLogo: 'تغيير الشعار الرئيسي:',
        changeRightLogo: 'تغيير الشعار الثانوي:',
        titleManagement: 'إدارة العنوان',
        titleFr: 'العنوان (بالفرنسية):',
        titleAr: 'العنوان (بالعربية):',
        titlePreview: 'معاينة العنوان:',
        saveSettings: 'حفظ الإعدادات',
        reset: 'إعادة التعيين',
        resetHint: 'استعادة الإعدادات الافتراضية للتطبيق.',
        ...
        filtered: 'مفلتر',
        filterById: 'تصفية حسب المعرف',
        allYears: 'كل السنوات',
        sortHint: 'رتب حسب الأعمدة بالنقر على العناوين',
        showing: 'عرض',
        of: 'من',
        items: 'عناصر',
